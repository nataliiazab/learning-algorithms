    ...
    variables: [
      {
        ...
        explanation: "Holds the running total of whatever's currently inside the window. It never stops changing — pour a new number in, scoop an old one out.",
      },
      {
        emoji: '🏆',
        name: 'bestSum',
        nickname: 'The Trophy Keeper',
        explanation: 'Only updates when windowSum beats it. The rest of the time it just sits there, quietly holding onto the record.',
      },
      {
        emoji: '👶',
        name: 'i',
        nickname: 'The Newborn Counter',
        explanation: "Only exists inside Loop 1, counting 0, 1, 2... up to k. The moment that loop ends, i vanishes for good — it never shows up again.",
      },
      {
        emoji: '👉',
        name: 'end',
        nickname: 'The Right Bookend',
        explanation: 'Always points at the newest number sliding INTO the window, on the right.',
      },
      {
        emoji: '👈',
        name: 'start',
        nickname: 'The Left Bookend',
        explanation: "Always points at the oldest number about to slide OUT, on the left. It's always exactly k steps behind end.",
      },
    ],
  },
  conceptGame: [
    { term: 'windowSum', isCode: false, answer: 'variable', feedback: 'Yep — that\'s the Tally Jar, holding our running total.' },
    { term: 'for (let i = 0; i < k; i++)', isCode: true, answer: 'loop', feedback: 'Right — the Builder loop, repeating k times.' },
    { term: 'bestSum', isCode: false, answer: 'variable', feedback: 'Correct — the Trophy Keeper, remembering our best score.' },
    { term: 'for (let end = k; end < arr.length; end++)', isCode: true, answer: 'loop', feedback: 'Yes — the Walker loop, one lap per remaining position.' },
    { term: 'end', isCode: false, answer: 'pointer', feedback: "That's a pointer — it marks WHERE we are, not a running total." },
    { term: 'start', isCode: false, answer: 'pointer', feedback: "Exactly, another pointer — marking the window's left edge." },
  ],
  quiz: [
    {
