...
export const UI = {
  en: {
    ...
    "tracer.loopBuild":
      "Loop 1 (building): runs songsPerRun times, adding one score to runScore each round - this builds our very first run.",
    "tracer.loopSlide":
      "Loop 2 (sliding): runs once per remaining position - each round drops the old left score, adds the new right score, and checks if this is our best run yet.",
    ...
    "builder.partialDone":
      "Nice - that line is in place. The rest is coming up in a bit.",
    ...
    "builder.finalCongrats":
      "🌟 Every line above is exactly the real `bestSongRun` function - and you chose each meaningful line yourself. Try pasting it into your browser's console; it really runs!",
    ...
    "challenge.intro":
      "Our window size is {k}. It's sitting at index 0–{lastIndex}, with a running total of {oldSum}. We're about to slide it one step to the right.",
    "challenge.q1": "1. Which number will leave the window?",
    "challenge.q2": "2. Which number will join the window?",
    "challenge.q3": "3. What will the new running total be?",
    "challenge.typeNumber": "Type a number",
    "challenge.check": "Check my answers",
    "challenge.explanationLead":
      "The window drops {leaving} and picks up {entering}, so the new total is",
    ...
    "complexity.subtitle":
      "No scary math - just an honest picture of best, typical, and worst case.",
    ...
    "window.sum": "Current total",
    "window.best": "Best total so far",
    ...
    "stage.inputs": "Meet the Inputs",
    "stage.loop1": "Loop 1: Building the First Run",
    "stage.bestScore": "Remembering the Best",
    "stage.loop2": "Loop 2: Sliding",
    "stage.recap": "You Wrote the Whole Thing!",
    "stage.tryit": "Try It Yourself",
    "stage.quiz": "Final Quiz",

    "stage.watchIt": "▶️ Watch it happen",
    "stage.yourTurn": "✍️ Your turn",
    "stage.meetCast": "🎭 Meet the cast, one more time",
    "stage.finishedFunction": "Here's the whole function, assembled by you",
    "stage.recapIntro":
      "You just filled in every meaningful line of a real algorithm. Let's see it all together, then play with the vocabulary one more time before the final quiz.",
    "stage.tryitIntro":
      "Now that you know how it works, play with it freely - change the numbers, change the window size, and use the full controls below.",
  ...
  uk: {
    ...
    "tracer.loopBuild":
      "Цикл 1 (побудова): виконується songsPerRun разів, щоразу додаючи один рівень до runScore - так будується перший прогін.",
    "tracer.loopSlide":
      "Цикл 2 (ковзання): виконується по одному разу для кожної залишеної позиції - щоразу прибирає старий рівень зліва, додає новий справа і перевіряє, чи це найкращий прогін.",
    ...
    "builder.partialDone": "Чудово - цей рядок на місці. Решта попереду.",
    "builder.progressSubtitle":
    ...
    "builder.finalCongrats":
      "🌟 Кожен рядок вище - це справжня функція `bestSongRun`, і кожен важливий рядок ти обрав(ла) сам(а). Спробуй вставити її у консоль браузера - вона справді працює!",
    ...
    "challenge.intro":
      "Розмір нашого вікна {k}. Воно зараз на позиції 0–{lastIndex}, і поточна сума дорівнює {oldSum}. Зараз ми зсунемо його на один крок вправо.",
    "challenge.q1": "1. Яке число покине вікно?",
    "challenge.q2": "2. Яке число приєднається до вікна?",
    "challenge.q3": "3. Якою буде нова поточна сума?",
    ...
    "complexity.subtitle":
      "Без страшної математики - чесна картина найкращого, типового та найгіршого випадку.",
    ...
    "stepper.step": "Крок",
    "stepper.stepOf": "Крок {current} з {total}",
    "stepper.back": "← Назад",
    "stepper.next": "Далі →",

    "stage.story": "Історія",
    "stage.inputs": "Знайомство зі вхідними даними",
    "stage.loop1": "Цикл 1: будуємо перший прогін",
    "stage.bestScore": "Запам'ятовуємо найкращий результат",
    "stage.loop2": "Цикл 2: ковзаємо",
    "stage.recap": "Ти написав(ла) усе це!",
    "stage.tryit": "Спробуй сам(а)",
    "stage.quiz": "Фінальний тест",

    "stage.watchIt": "▶️ Подивись, як це працює",
    "stage.yourTurn": "✍️ Твоя черга",
    "stage.meetCast": "🎭 Познайомся з дійовими особами ще раз",
    "stage.finishedFunction": "Ось уся функція, яку ти зібрав(ла)",
    "stage.recapIntro":
      "Ти щойно заповнив(ла) кожен важливий рядок справжнього алгоритму. Подивімось на все разом, а потім ще раз пограємось зі словником, перш ніж фінальний тест.",
    "stage.tryitIntro":
      "Тепер, коли ти знаєш, як це працює, погратись вільно - зміни числа, зміни розмір вікна і скористайся повним набором керування нижче.",

    "quickcheck.title": "🤔 Швидка перевірка",
  },
};
